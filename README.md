...
- Added a production Netlify configuration at the repository root with the app base directory, Node 22, static asset caching, security headers, SPA fallback, and a scheduled OpenRouter sync placeholder.
...
- Added reusable scoring, pricing, OpenRouter normalization, and Supabase cache service modules in the app.
...
- **OpenRouter** is the primary live model source via `https://openrouter.ai/api/v1/models?output_modalities=all`.
